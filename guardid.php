...
$sql="select * from guardreg where barcode='$barcode'";
...
<div class="container">
		<div class="tabs">
		 ...
		 <form action="guarddataid.php" method="post"  onSubmit="return valid(this)">
	     
			<br/>
			<input class="field" type="text" name="guardid" id="otherfield" placeholder="ENTER GUARD ID"/>
<script>
