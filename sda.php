...
<div class="container">
		<div class="tabs">
	     ...
	     <input type="submit" onclick="checkpass()" value="Entry" style="width: 30%; height: 30%;"
			<br/>
...
<script>
 ...
 <input type="submit" id="btn" onclick="checkpass()" value="Exit" style="width: 30%; height: 30%;"/>
						</form>
