...
<div class="container">
		<div class="tabs">
		 ...
		 <form action="studentexit.php" method="post"  onSubmit="return valid(this)">
	     <input type="submit" onclick="checkpass()" value="Exit" style="width: 25%; height: 25%; margin-right:150px;"
			<br/>
			...
			<input class="field" type="text" name="otherfield" id="otherfield" placeholder="OTHERPLACE"/></form>
<script>
...
<script>
   ...
   if(document.getElementById("otherfield").value == "")
   {
	...
	else
	{
		...
		<form action="studententry.php" method="post"  onSubmit="return valid(this)">
 <input type="submit" id="btn" onclick="checkpass()" value="Entry" style="width: 25%; height: 25%; margin-right:350px;"/>
 <script>
   function ValueIs(place) {
